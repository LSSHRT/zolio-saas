...
const heroPillars = [
  {
    icon: Clock,
    title: "Devis en 24h",
    description: "Modèles de devis adaptés à vos besoins et conformes aux normes NF C 15-100.",
  },
  {
    icon: CheckCircle2,
    title: "Factures automatiques",
    description: "Suivi des paiements après chaque chantier et relances sans lever le petit doigt.",
  },
  {
    icon: ShieldCheck,
    title: "Attestations obligatoires",
    description: "Prise en charge du Consuel, de vos assurances décennales et de l'URSSAF.",
  },
] as const;
                ...
                <div className="flex-1 p-3 space-y-3 flex flex-col bg-white/[0.02]">
                  ...
                  <div className="space-y-2">
                     <div className="flex justify-between items-center">
                        <span className="text-[10px] text-neutral-300">Tableau électrique</span>
...
export default function LandingPage() {
  ...
  const supportHref = getSupportHref({
    subject: "Zolio pour Électriciens - Demande d'appel 15 min",
    message:
            ...
            <div className="landing-panel flex h-[4.5rem] items-center justify-between rounded-2xl px-4 sm:px-6">
              <div className="flex items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="hidden text-[10px] uppercase tracking-[0.28em] text-white/45 sm:block">
                    Spécialisé Électriciens BTP
                  </span>
                </div>
              </div>
              
              <div className="hidden md:flex items-center space-x-8">
                <a href="#features" className="text-sm font-medium text-neutral-300 hover:text-white transition-colors">Services</a>
            ...
            {isMobileMenuOpen && (
              ...
              >
                <div className="landing-panel rounded-2xl px-4 pb-6 pt-4">
                  ...
                  <a href="#features" onClick={() => setIsMobileMenuOpen(false)} className="block text-base font-medium text-neutral-300 hover:text-white">Services</a>
                  ...
                  <Link href={supportHref} onClick={() => setIsMobileMenuOpen(false)} className="inline-block px-5 py-3 rounded-xl bg-white text-black text-base font-semibold text-center w-full mt-4">
                    Réserver un appel (15 min)
                  </Link>
                </div>
                </div>
            ...
            <div className="grid gap-10 xl:grid-cols-[1.04fr_0.96fr] xl:items-center">
              <div className="text-center xl:text-left">
                <div className="flex justify-center xl:justify-start">
                  <SectionEyebrow>Zolio • Secrétariat & Administratif pour Électriciens</SectionEyebrow>
                </div>

                <KineticText
                  text="Je gère vos devis, factures et administratif"
                ...
                <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-neutral-300 sm:text-xl xl:mx-0">
                  Électriciens du BTP : Gagnez <span className="text-white font-semibold">10h par semaine</span> d&apos;administratif et ne perdez plus aucun client.
                  À partir de <span className="text-violet-400 font-bold">150 €/mois, sans engagement</span>. Premier mois 100% gratuit.
                </p>
                ...
                <div className="mt-6 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 xl:justify-start">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm text-neutral-400">
                      <span className="font-bold text-white">45+</span> électriciens partenaires
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm text-neutral-400">
                      <span className="font-bold text-white">1 500+</span> devis & attestations gérés
                    </p>
                  </div>
                </div>
                        ...
                        <div className="flex items-center justify-between group cursor-default">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-neutral-500 text-[10px]">Mme. Martin - Installation Bornes</span>
                            </div>
                          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-sm font-medium text-neutral-300 backdrop-blur-md">
                ...
                VOTRE SECRÉTARIAT DÉDIÉ
              </div>
              <h2 className="mx-auto mt-6 max-w-3xl text-3xl font-bold tracking-tight text-white sm:text-5xl">
                Une gestion administrative <span className="bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">complète et sur-mesure</span>
              </h2>
              <p className="mx-auto mt-4 max-w-2xl text-lg text-neutral-400">
                Plus besoin d&apos;attendre le soir pour rédiger vos devis ou relancer vos clients. Nous prenons tout en charge.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  name: "Jean-Marc P.",
                  role: "Électricien indépendant — Angers",
                  text: "Déléguer mes devis et mes relances à Zolio m'a changé la vie. Mes chantiers sont facturés à temps et mes attestations Consuel partent sans aucun retard.",
                  rating: 5,
                  initial: "J",
                ...
                },
                {
                  ...
                  text: "Ce qui m'a convaincu, c'est la signature digitale pour les devis de mise aux normes. Le client signe direct sur ma tablette en fin de chantier, c'est nickel.",
                  rating: 5,
                  initial: "L",
        ...
        <LandingStage id="pricing" className="relative py-32" tone="warm">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              ...
              >
                <div className="w-2 h-2 rounded-full bg-yellow-500 motion-safe:animate-pulse"></div>
                <span className="text-sm font-semibold text-yellow-400 tracking-wide uppercase">OFFRE DE LANCEMENT LIMITÉE</span>
              </motion.div>
              <motion.h2 
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                Des tarifs <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-fuchsia-400 to-orange-400 animate-gradient bg-300%">clairs et sans surprise</span>
              </motion.h2>
              <motion.p 
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                Choisissez le forfait adapté à votre activité. Externalisez votre paperasse à un assistant dédié à votre métier d&apos;électricien.
              </motion.p>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3 }}
                className="mt-8 inline-block rounded-2xl bg-gradient-to-r from-violet-600/20 via-fuchsia-600/20 to-orange-600/20 border border-violet-500/30 px-6 py-4 backdrop-blur-md max-w-3xl mx-auto"
              >
                <p className="text-base text-violet-200">
                  🎁 <span className="font-bold text-white">Exclusivité de lancement :</span> Le <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-400">1er mois est 100% offert</span> pour les 5 premiers électriciens partenaires !
                </p>
              </motion.div>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto mb-16">
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-neutral-900/80 border border-neutral-800 p-8 h-full flex flex-col justify-between">
                  <div>
                    <div className="flex justify-between items-baseline mb-6">
                      <div>
                        <h3 className="text-2xl font-bold text-white mb-1">Découverte</h3>
                        <p className="text-neutral-400 text-sm">Idéal 1 à 3 chantiers / mois</p>
                      </div>
                      <div className="text-right">
                        <span className="text-4xl font-extrabold text-white">150€</span>
                        <span className="text-neutral-500 block mt-1 text-sm">/mois HT</span>
                      </div>
                    </div>
                    ...
                    <ul className="space-y-4 mb-8">
                      {[
                        'Devis & Factures (jusqu\'à 3 chantiers)',
                        'Modèles NF C 15-100 conformes',
                        ...
                        <li key={i} className="flex items-start text-neutral-300">
                          <CheckCircle className="w-5 h-5 mr-3 flex-shrink-0 text-neutral-500 mt-0.5" />
              ...
              >
                ...
                <div className="relative overflow-hidden rounded-3xl bg-neutral-950/90 border border-violet-500/30 p-8 h-full flex flex-col justify-between shadow-[inset_0_0_60px_rgba(139,92,246,0.08)]">
                  <div className="absolute top-4 right-4 px-3 py-1 bg-gradient-to-r from-violet-600 to-fuchsia-600 rounded-full text-[10px] font-bold text-white tracking-wider border border-white/10">POPULAIRE</div>
                  
                  <div>
                    <div className="flex justify-between items-baseline mb-6">
                      <div>
                        <h3 className="text-2xl font-bold text-white mb-1">Standard</h3>
                        <p className="text-violet-300 text-sm">Idéal 4 à 10 chantiers / mois</p>
                      </div>
                      <div className="text-right">
                        <span className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-white to-white/70">199€</span>
                        <span className="text-neutral-400 block mt-1 text-sm">/mois HT</span>
                      </div>
                    </div>

                    <div className="h-px bg-violet-500/10 my-6" />

                    <ul className="space-y-4 mb-8">
                      {[
                        'Devis & Factures (jusqu\'à 10 chantiers)',
                        'Tout le plan Découverte inclus',
                        'Dossier de Consuel pré-rempli',
                        'Gestion de 2 sous-traitants max',
                        'Relances téléphoniques incluses',
                        'Support WhatsApp & Téléphone dédié',
                        'Relances de paiements personnalisées'
                      ].map((f, i) => (
                        <li key={i} className="flex items-start text-neutral-200">
                          <CheckCircle className="w-5 h-5 mr-3 flex-shrink-0 text-violet-400 mt-0.5" />
                  ...
                  >
                    Réserver mon appel (1er mois gratuit)
                  </Link>
                </div>
              </motion.div>
                  ...
                  <div>
                    <div className="flex justify-between items-baseline mb-6">
                      <div>
                        ...
                        <p className="text-neutral-400 text-sm">Plus de 10 chantiers / mois</p>
                      </div>
                      <div className="text-right">
                    ...
                    <ul className="space-y-4 mb-8">
                      {[
                        ...
                        'Dossiers Consuel prioritaires (24h)',
                        'Gestion sous-traitants illimitée',
                        'Export comptable automatisé',
                        'Conseiller dédié 6 jours sur 7',
                        'Ajustements devis en temps réel'
                      ].map((f, i) => (
                        <li key={i} className="flex items-start text-neutral-300">
                          <CheckCircle className="w-5 h-5 mr-3 flex-shrink-0 text-neutral-500 mt-0.5" />
                          <span className="text-sm">{f}</span>
            ...
            <p className="text-center text-sm text-neutral-500 font-light">
              Tous nos forfaits sont sans aucun engagement. Vous pouvez changer de formule ou résilier sur simple message WhatsApp.
            </p>
          </div>
        </LandingStage>
        ...
        <LandingStage id="faq" className="relative py-32" tone="neutral">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              <FAQItem 
                question="Comment se passe la transition vers votre service ?" 
                answer="C&apos;est ultra simple. Nous récupérons vos anciens devis, vos tarifs habituels et votre liste de clients. En 48h, nous configurons tout votre espace de suivi pour que vous n&apos;ayez qu&apos;à nous envoyer vos instructions par SMS, WhatsApp ou mémo vocal." 
              />
              <FAQItem 
                question="Comment garantissez-vous la conformité aux normes NF C 15-100 ?" 
                answer="Chaque devis et facture émis mentionne précisément les normes de sécurité requises, les spécifications techniques du matériel d&apos;électricité générale et respecte à la lettre la réglementation française. Nos assistants sont formés aux exigences techniques du métier." 
              />
              <FAQItem 
                question="Comment gérez-vous les attestations de conformité Consuel ?" 
                answer="Nous préparons l&apos;ensemble de vos dossiers techniques de demande d&apos;attestation Consuel (Jaune pour le résidentiel, Vert pour le tertiaire, Bleu pour le photovoltaïque). Nous complétons les formulaires et les suivons pour vous auprès de l&apos;organisme." 
              />
              <FAQItem 
                question="Comment fonctionne l&apos;offre du premier mois gratuit ?" 
                answer="Pour les 5 premiers électriciens qui rejoignent Zolio, nous offrons 30 jours de gestion administrative complète (devis, factures, relances et Consuel) sans facturation et sans aucun engagement. C&apos;est l&apos;occasion de tester sans risque l&apos;efficacité du service." 
              />
              <FAQItem 
                question="Est-ce une application ou un service d&apos;assistant humain ?" 
                answer="Le meilleur des deux mondes. Vous bénéficiez d&apos;un espace client sécurisé pour suivre vos devis, paiements et chantiers en temps réel. Mais toute la saisie administrative complexe et les relances sont assurées par des assistants experts dédiés à votre entreprise." 
              />
            </div>
          </div>
        </LandingStage>
              ...
              <div className="relative grid gap-10 lg:grid-cols-[1fr_0.82fr] lg:items-end">
                <div>
                  ...
                  <p className="mt-5 max-w-2xl text-lg leading-8 text-neutral-300">
                    Ne perdez plus un seul chantier à cause d&apos;un devis envoyé en retard. Laissez nos spécialistes de l&apos;électricité s&apos;occuper de votre gestion pendant que vous êtes sur le terrain.
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-neutral-400 max-w-sm">
                  Le partenaire de gestion administrative nouvelle génération dédié aux artisans électriciens.
                  Libérez-vous des devis, factures et attestations Consuel.
                </p>
              </div>
              <div>
                <h4 className="text-white font-semibold mb-6">Service</h4>
                <ul className="space-y-4">
                  <li><a href="#features" className="text-neutral-400 hover:text-white transition-colors">Prestations</a></li>
                  <li><a href="#pricing" className="text-neutral-400 hover:text-white transition-colors">Tarifs</a></li>
                  <li><Link href={supportHref} className="text-neutral-400 hover:text-white transition-colors">Nous contacter</Link></li>
                </ul>
              </div>
              <div>
            ...
            >
              <div className="rounded-2xl border border-white/10 bg-[#05050A]/85 p-2 pb-3 shadow-[0_20px_60px_rgba(0,0,0,0.5)] backdrop-blur-xl">
                ...
                <p className="mt-2 flex items-center justify-center gap-1.5 text-[11px] text-neutral-400">
                  ...
                  100% gratuit le premier mois · Sans engagement
                </p>
              </div>
            </motion.div>
          )}
