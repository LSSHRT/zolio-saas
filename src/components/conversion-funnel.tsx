      ...
      <div className="space-y-3">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="flex items-center gap-3 rounded-xl bg-slate-100/50 dark:bg-white/5 px-4 py-3">
            <div className="h-3 w-3 shrink-0 rounded-full bg-slate-200 dark:bg-white/10 animate-pulse"></div>
            <div className="min-w-0 flex-1 space-y-2">
              <div className="flex items-center justify-between">
                <div className="h-4 w-24 rounded bg-slate-200 dark:bg-white/10 animate-pulse"></div>
                <div className="h-3 w-12 rounded bg-slate-200 dark:bg-white/10 animate-pulse"></div>
              </div>
              <div className="h-2 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-white/10 animate-pulse"></div>
              <div className="flex items-center justify-between">
                <div className="h-3 w-16 rounded bg-slate-200 dark:bg-white/10 animate-pulse"></div>
                <div className="h-3 w-12 rounded bg-slate-200 dark:bg-white/10 animate-pulse"></div>
              </div>
            </div>
            <div className="h-4 w-4 rounded-full bg-slate-200 dark:bg-white/10 animate-pulse"></div>
          </div>
        ))}
      </div>
    );
