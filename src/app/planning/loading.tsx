...
export default function Loading() {
  return (
    <div className="container mx-auto space-y-6 p-6">
      ...
      {/* Info banner */}
      <div className="h-24 rounded-[1.5rem] bg-gray-200 dark:bg-gray-700 animate-pulse" />

      {/* Planning items */}
      <div className="flex flex-col gap-3">
        {[1, 2, 3].map((i) => (
          <div key={i} className="rounded-[1.75rem] border border-slate-100 bg-slate-50 p-5 dark:border-white/8 dark:bg-white/4 animate-pulse">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              <div className="h-20 rounded-[1.25rem] bg-gray-200 dark:bg-gray-700" />
              <div className="h-20 rounded-[1.25rem] bg-gray-200 dark:bg-gray-700" />
            </div>
