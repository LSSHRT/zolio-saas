                            ...
                            <div className="min-w-0 flex-1">
                              <div className="flex items-start justify-between gap-3">
                                <div className="min-w-0">
                                  <Link href={`/clients/${client.id}`} className="truncate text-sm font-semibold text-slate-950 dark:text-white hover:text-violet-600 dark:hover:text-violet-400 transition-colors">
                                    {client.nom}
                                  </Link>
                        ...
                        <div className="hidden p-5 md:block">
                          <div className="flex items-start justify-between gap-3">
                            <div className="flex min-w-0 items-start gap-3">
                              ...
                              <div className="min-w-0">
                                <Link href={`/clients/${client.id}`} className="truncate block text-sm font-semibold text-slate-950 dark:text-white hover:text-violet-600 dark:hover:text-violet-400 transition-colors">
                                  {client.nom}
                                </Link>
                                <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                  Ajouté le {client.dateAjout}
