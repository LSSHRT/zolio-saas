...
export default function Loading() {
  return (
    <div className="min-h-screen bg-[#05050A] py-20 px-4 sm:px-6 relative overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-orange-900/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="h-5 w-36 rounded bg-gray-700 animate-pulse mb-12" />
        <div className="mx-auto h-10 w-80 rounded bg-gray-700 animate-pulse mb-12" />
