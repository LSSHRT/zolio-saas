  ...
  return (
    <div className="container mx-auto space-y-6 p-6">
      ...
      <div className="flex flex-col gap-3">
        {[1, 2, 3].map((i) => (
          <div key={i} className="rounded-2xl border border-slate-100 bg-slate-50 p-4 dark:border-white/8 dark:bg-white/4">
            ...
            <div className="flex items-center justify-between mt-3 pt-3 border-t border-slate-100 dark:border-slate-800">
              ...
              <div className="h-8 w-12 bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse" />
