            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
                ...
                <div className="lg:col-span-2 flex flex-col gap-4 lg:gap-6">
                  {/* KPI */}
                  <motion.section {...sectionMotion(0.04)} className="client-panel rounded-[2rem] p-4 sm:p-5 xl:p-4 w-full">
                ...
                <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
                  ...
                  {/* Trésorerie */}
                  <div className={`${showMoreMobile ? "block" : "hidden sm:block"}`}>
                    {/* Trésorerie */}
              ...
              {funnel && funnel.length > 0 && (
                <motion.section {...sectionMotion(0.09)} className="client-panel rounded-[2rem] p-4 sm:p-5 xl:p-4">
